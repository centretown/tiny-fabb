{{define "select-bar"}}
<div class="w3-bar w3-theme-d3 w3-border">
    <select
...
{{define "app-bar"}}
<div id="app-bar" class="w3-bar w3-border w3-theme-d3 w3-border">
    <div class="w3-dropdown-hover w3-left w3-theme-d3 w3-bar-item">
        <button class="w3-button app-icon">
            <i class="bi bi-menu-button"></i>
        </button>
        <div id="menu-left" class="w3-dropdown-content w3-bar-block w3-border w3-theme-d1">
